...
const ResumePage = () => {
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      {/* Main Content */}
      <main className="flex-grow flex justify-center pt-20 pb-12 px-4 md:px-12">
        <div className="w-full max-w-6xl bg-white shadow-lg rounded-lg flex flex-col md:flex-row overflow-hidden">
          
          {/* Sidebar */}
          <aside className="w-full md:w-1/3 bg-gray-900 text-white p-6 space-y-6">
            {/* Name & Title */}
            <div>
          ...
          {/* Main Content */}
          <section className="w-full md:w-2/3 p-6 md:p-10 space-y-10">
